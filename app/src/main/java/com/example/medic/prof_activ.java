...
public class prof_activ extends AppCompatActivity {
    ...
    private void setSetting() {
        ...
        next.setOnClickListener(view -> {
            Intent create_password = new Intent(prof_activ.this, pass.class);
            startActivity(create_password);
        });
    }

    private void setSpinner() {
        String[] items = new String[]{"Не указано","Женский", "Мужской"};
