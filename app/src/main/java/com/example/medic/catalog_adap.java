...
public class catalog_adap extends RecyclerView.Adapter<catalog_adap.MyViewHolder> {

    private Context catalogContext;
    private List<catalog> catalogData;

    public catalog_adap(Context catalogContext, List<catalog> newsData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        v = inflater.inflate(R.layout.catalog, parent, false);
